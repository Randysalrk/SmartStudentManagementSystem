...
public class ViewStudentDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.getAccessibleContext().setAccessibleName("profilePicture");
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
       try{
          ...
          if(search.next())
          {
            ...
            Blob blob = search.getBlob("image");
            InputStream in = blob.getBinaryStream();
            Image image = ImageIO.read(in);
            Image resizedImage = image.getScaledInstance(jLabel9.getWidth(), jLabel9.getHeight(), Image.SCALE_SMOOTH);
